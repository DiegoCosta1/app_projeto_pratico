...
class TelaCadastroJogo extends StatefulWidget {
  @override
  _TelaCadastroJogoState createState() => _TelaCadastroJogoState();
}
...
class _TelaCadastroJogoState extends State<TelaCadastroJogo> {
  ...
  var txtDesenvolvedora = TextEditingController();
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(children: [
          ...
          SizedBox(height: 5),
          campoTexto("Desenvolvedora", txtDesenvolvedora, null, false, context),
          SizedBox(height: 5),
